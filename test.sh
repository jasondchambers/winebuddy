...
output=$(uv run python winebuddy.py query --limit 5)
...
output=$(uv run python winebuddy.py query --color Red --limit 3)
if echo "$output" | grep -q "wine(s) found"; then
...
output=$(uv run python winebuddy.py query --varietal "Pinot Noir" --limit 3)
...
output=$(uv run python winebuddy.py query --vintage-max 2015 --limit 5)
if echo "$output" | grep -q "wine(s) found"; then
...
output=$(uv run python winebuddy.py query --in-stock --limit 5)
if echo "$output" | grep -q "wine(s) found"; then
...
output=$(uv run python winebuddy.py query --sort score --desc --limit 5)
if echo "$output" | grep -q "wine(s) found"; then
...
output=$(uv run python winebuddy.py query --limit 2 --format json)
...
output=$(uv run python winebuddy.py query --limit 2 --format csv)
...
output=$(uv run python winebuddy.py query --color Red --in-stock --sort vintage --limit 5)
if echo "$output" | grep -q "wine(s) found"; then
...
output=$(uv run python winebuddy.py query --producer "Château" --limit 3)
if echo "$output" | grep -q "wine(s) found"; then
...
output=$(uv run python winebuddy.py query --country USA --limit 3)
if echo "$output" | grep -q "wine(s) found"; then
...
output=$(uv run python winebuddy.py query -c Red -l 2 -f json)
...
output=$(uv run python winebuddy.py discover colors)
if echo "$output" | grep -q "Colors"; then
...
output=$(uv run python winebuddy.py discover regions)
if echo "$output" | grep -q "Regions"; then
